...
import 'package:flutter_proj/features/admin/presentation/controllers/user_controller.dart';
import 'package:flutter_proj/features/admin/presentation/controllers/user_list_controller.dart';
                            ...
                            trailing: SizedBox(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  }, icon:userController.isLoading ? Center(child: CircularProgressIndicator()) : const Icon(Icons.delete))
                                ],
                              ),
                            ),
                          );
